...
export const EPISODE_07_COMMANDER_MOBIBOU = createComedyEpisode({
  ...
  reversal: [['司令官', 'なぜ音声、鈴、帽子がここに！'], ['もびぼう', '記念写真と受領印も落ちてきた。'], ['ナレーション', '六つの小さな失敗が順番に発動し、完璧な計画だけが配送された。']], choicePrompt: '作戦名を直す？　理由欄を直す？', endings: [{ label: '作戦名を「だいたい成功」', title: '評価変更', lines: [['司令官', '目標は一体も確保できていない。'], ['もびぼう', '怪盗団は全員集合できたよ。'], ['司令官', '親睦会ではない！']] }, { label: '理由を「全部不可抗力」', title: '報告書の勝利', lines: [['司令官', '原因分析になっていない。'], ['もびぼう', 'でも欄にぴったり入った。'], ['ナレーション', '司令官はレイアウトだけ認めた。']] }],
