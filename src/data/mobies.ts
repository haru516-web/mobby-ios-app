...
export const MOBBIES: Mobby[] = [
  ...
  },
  {
    ...
    tags: ['堕天', '魔眼', '王'],
    lines: {
      tease: ['我が魔眼をつつくとは……貴様、見どころがあるな。', '闇の力が疼く。これは波乱の予兆だ。', '禁断のほっぺを解放したな……責任は取れ。', '伸びよ、漆黒の頬！ ……そこ、笑うでない。', 'この弾力こそ、失われし王家の秘宝だ。'],
  ...
  },
  {
    ...
    lines: {
      ...
      gift: ['記念品？ ちがうし、プレゼントならもらうけど！', '……ありがと。なくしたら怒るからな！'],
    },
  },
  {
    id: 'babumoby',
