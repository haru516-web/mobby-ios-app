...
export const MOBBIES: Mobby[] = [
  {
    ...
    tags: ['思索', '静けさ', '哀愁'],
    lines: {
      tease: ['……ほう。そこをつつくとは、なかなか深いですな。', '真実を急かしてはいけませんぞ。'],
  ...
  },
  {
    ...
    tags: ['直感', '自由', '肯定'],
    lines: {
      tease: ['えっ、今つついた？ もっかいやって〜♡', 'ちょっかいも楽しいならアリじゃん？'],
  ...
  },
  {
    ...
    tags: ['不安', '安心', '寄り添い'],
    lines: {
      tease: ['……びっくりした。もう少しだけ、ここにいて？', '嫌じゃないけど、急にいなくならないでね。'],
  ...
  },
  {
    ...
    tags: ['信念', '挑戦', '行動力'],
    lines: {
      tease: ['おう、やるやん！ そのくらいの勢いで来いや！', '邪魔された？ なら、ここからが勝負や！'],
  ...
  },
  {
    ...
    tags: ['堕天', '魔眼', '王'],
    lines: {
      tease: ['我が魔眼をつつくとは……貴様、見どころがあるな。', '闇の力が疼く。これは事件の予兆だ。'],
  ...
  },
  {
    ...
    tags: ['王子様', 'ときめき', '演出'],
    lines: {
      tease: ['ふふ、そんなに僕に触れたいの？ 今夜は君だけのものさ。', 'その悪戯も、僕へのファンサービスかな？'],
  ...
  },
  {
    ...
    tags: ['休息', '安心', 'だらだら'],
    lines: {
      tease: ['んー……あと五分だけ。つつくのは寝ながらでもできるよ。', '起こした？ じゃあ一緒に二度寝しよ。'],
  ...
  },
  {
    ...
    tags: ['いたずら', '反応', '悪ガキ'],
    lines: {
      tease: ['えー、モビ坊じゃないし！ ……もう一回なら許すけど。', '先に触ったのそっちじゃん！ 仕返しね！'],
  ...
  },
  {
    ...
    tags: ['ばぶ', '眠気', '甘え'],
    lines: {
      tease: ['ばぶぅ……びっくり……だっこ……？', 'やー！ ……でも、もういっかい。'],
