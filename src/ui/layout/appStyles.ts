...
export const styles = StyleSheet.create({
  ...
  onboardingKicker: { color: '#A0797F', fontSize: 12, fontWeight: '900', letterSpacing: 1.8 },
  ...
  openingTitleSub: { color: '#8B647E', fontSize: 12, fontWeight: '900', letterSpacing: 2.6, marginTop: 1 },
  ...
  eyebrow: { color: '#9A7485', fontSize: 12, fontWeight: '900', letterSpacing: 1.8 },
