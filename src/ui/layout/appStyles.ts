...
export const styles = StyleSheet.create({
  ...
  caseHeaderButton: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center' },
  ...
  caseHeaderBadgeText: { color: '#FFF', fontSize: 12, lineHeight: 11, fontWeight: '900' },
  ...
  homeReorderButtonTextActive: { color: '#FFF9EC' },
  ...
  reactionBookButton: { position: 'absolute', right: 10, top: '45%', minWidth: 92, minHeight: 62, zIndex: 24 },
  reactionBookButtonCompact: { right: 6, top: '43%', minWidth: 82, minHeight: 56 },
  ...
  dailyHomeToggle: { position: 'absolute', top: 4, left: 14, zIndex: 26, minWidth: 92, minHeight: 44, overflow: 'hidden' },
  dailyHomeToggleContent: { minWidth: 92, minHeight: 44, paddingHorizontal: 10, paddingVertical: 4, flexDirection: 'column', alignItems: 'center', justifyContent: 'center' },
  dailyHomeToggleBurst: { position: 'absolute', top: 4, left: 14, width: 92, height: 34, zIndex: 27 },
  dailyHomeToggleText: { color: '#6B4A62', fontSize: 12, fontWeight: '900', letterSpacing: 0.7 },
  dailyPendingText: { color: '#92716F', fontSize: 13, lineHeight: 18, fontWeight: '700', marginTop: 2 },
  dailyDisabled: { opacity: 0.48 },
  collectionHeaderBar: { position: 'absolute', top: 8, left: 18, right: 18, height: 54, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', zIndex: 10, overflow: 'hidden' },
  ...
  collectionKeySizeTabs: { position: 'absolute', top: 66, right: 27, width: 184, height: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 9, gap: 3, overflow: 'hidden', zIndex: 10 },
